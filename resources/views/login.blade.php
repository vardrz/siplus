...
<head>
  ...
  <title>
    Sistem Informasi Pengumuman Kelulusan - SMKN 01 Kuvukiland
  </title>
  <!--     Fonts and icons     -->
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-info shadow-info border-radius-lg py-3 pe-1">
                  ...
                  <div class="text-white text-center mt-2 mb-0">Administrator</div>
                </div>
              </div>
              <div class="card-body">
                ...
                @endif
                <form method="POST" action="/auth" role="form" class="text-start">
                  @csrf
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-info w-100 mb-2">Login</button>
                  </div>
                </form>
              </div>
            </div>
